...
class Test extends Controller
{
    ...
    {
        $this->url = apiuri('wechat-client/test/jsapi', [], false, true);
    ...
    {
        $this->url = apiuri('wechat-client/test/oauth', [], false, true);
        return $this->_buildQrcResponse($this->url);
    }
    ...
    {
        $this->url = apiuri('wechat-client/test/jssdk', [], false, true);
        return $this->_buildQrcResponse($this->url);
    }
    ...
    {
        $code = CodeToolkit::uniqidDate(18, 'TX');
        ...
        //        'total_fee'        => '1',
        //        'trade_type'       => 'NATIVE',
        //        'notify_url'       => apiuri('wechat-client/test/notify', [], false, true),
    ...
    public function jsapi()
    {
        ...
        // 生成支付参数
        $oCode = CodeToolkit::uniqidDate(18, 'TX');
