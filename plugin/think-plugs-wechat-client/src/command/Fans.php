...
use plugin\wechat\client\model\WechatFansTags;
use plugin\wechat\client\service\FansService;
...
class Fans extends Command
{
    ...
    {
        $appid = WechatService::getAppid();
        $this->writeConsoleMessage('开始获取微信用户数据');
        ...
        $this->writeConsoleMessage($done > 0 ? '微信用户数据获取完成' : '未获取到微信用户数据');
