...
class AliossStorage implements StorageInterface
{
    ...
    {
        return [
            'oss-cn-hangzhou.aliyuncs.com' => static::trans('华东 1（杭州）'),
            'oss-cn-shanghai.aliyuncs.com' => static::trans('华东 2（上海）'),
            'oss-cn-nanjing.aliyuncs.com' => static::trans('华东 5（南京本地地域）'),
            'oss-cn-fuzhou.aliyuncs.com' => static::trans('华东 6（福州本地地域）'),
            'oss-cn-qingdao.aliyuncs.com' => static::trans('华北 1（青岛）'),
            'oss-cn-beijing.aliyuncs.com' => static::trans('华北 2（北京）'),
            'oss-cn-zhangjiakou.aliyuncs.com' => static::trans('华北 3（张家口）'),
            'oss-cn-huhehaote.aliyuncs.com' => static::trans('华北 5（呼和浩特）'),
            'oss-cn-wulanchabu.aliyuncs.com' => static::trans('华北 6（乌兰察布）'),
            'oss-cn-shenzhen.aliyuncs.com' => static::trans('华南 1（深圳）'),
            'oss-cn-heyuan.aliyuncs.com' => static::trans('华南 2（河源）'),
            'oss-cn-guangzhou.aliyuncs.com' => static::trans('华南 3（广州）'),
            'oss-cn-chengdu.aliyuncs.com' => static::trans('西南 1（成都）'),
            'oss-cn-hongkong.aliyuncs.com' => static::trans('中国（香港）'),
            'oss-us-west-1.aliyuncs.com' => static::trans('美国（硅谷）'),
            'oss-us-east-1.aliyuncs.com' => static::trans('美国（弗吉尼亚）'),
            'oss-ap-northeast-1.aliyuncs.com' => static::trans('日本（东京）'),
            'oss-ap-northeast-2.aliyuncs.com' => static::trans('韩国（首尔）'),
            'oss-ap-southeast-1.aliyuncs.com' => static::trans('新加坡'),
            'oss-ap-southeast-2.aliyuncs.com' => static::trans('澳大利亚（悉尼）'),
            'oss-ap-southeast-3.aliyuncs.com' => static::trans('马来西亚（吉隆坡）'),
            'oss-ap-southeast-5.aliyuncs.com' => static::trans('印度尼西亚（雅加达）'),
            'oss-ap-southeast-6.aliyuncs.com' => static::trans('菲律宾（马尼拉）'),
            'oss-ap-southeast-7.aliyuncs.com' => static::trans('泰国（曼谷）'),
            'oss-ap-south-1.aliyuncs.com' => static::trans('印度（孟买）'),
            'oss-eu-central-1.aliyuncs.com' => static::trans('德国（法兰克福）'),
            'oss-eu-west-1.aliyuncs.com' => static::trans('英国（伦敦）'),
            'oss-me-east-1.aliyuncs.com' => static::trans('阿联酋（迪拜）'),
            'oss-rg-china-mainland.aliyuncs.com' => static::trans('无地域属性（中国内地）'),
        ];
    }
    ...
    protected function init()
    {
        ...
        if ($type === 'auto') {
            ...
            throw new Exception(static::trans('未配置阿里云域名'));
        }
    }
