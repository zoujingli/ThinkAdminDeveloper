 ...
 * +----------------------------------------------------------------------
 */
use plugin\system\storage\AliossStorage;
use plugin\system\storage\AlistStorage;
use plugin\system\storage\LocalStorage;
use plugin\system\storage\QiniuStorage;
use plugin\system\storage\StorageAuthorize;
use plugin\system\storage\TxcosStorage;
use plugin\system\storage\UpyunStorage;
