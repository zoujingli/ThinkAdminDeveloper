...
return array_merge($extra, [
    ...
    '请输入账号昵称' => 'Please enter account nickname',
    '登录次数' => 'Login Count',
    '账号状态' => 'Account Status',
    '编辑用户' => 'Edit User',
    '设置密码' => 'Set Password',
    '密 码' => 'Password',
    '请选择登录时间' => 'Please select login time',
    '请选择创建时间' => 'Please select create time',
    '搜 索' => 'Search',

    // 密码管理
    '登录用户账号' => 'Login Username',
    '请输入4位及以上字符登录用户账号' => 'Please enter login username with at least 4 characters',
    '登录用户账号创建后，不允许再次修改。' => 'Login username cannot be modified after creation.',
    '旧的登录密码' => 'Old Login Password',
