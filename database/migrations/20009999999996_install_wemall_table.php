...
class InstallWemallTable extends Migrator
{
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_agent', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_coupon', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_discount', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_level', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-配置-等级',
        ]), [
            ['name', 'string', ['limit' => 180, 'default' => '', 'null' => true, 'comment' => '级别名称']],
            ['cover', 'string', ['limit' => 500, 'default' => '', 'null' => true, 'comment' => '等级图标']],
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_notify', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_poster', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_config_rebate', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_express_company', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_express_template', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_goods', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_goods_cate', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_goods_item', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_goods_mark', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_goods_stock', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_help_feedback', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_help_problem', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_help_question', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_help_question_x', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order_cart', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order_item', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order_refund', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order_send', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_order_sender', [
            'engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '商城-订单-配送',
        ]), [
            ['ssid', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '所属商家']],
            ['unid', 'biginteger', ['limit' => 20, 'default' => 0, 'null' => true, 'comment' => '商城用户编号']],
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_action_collect', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_action_comment', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_action_history', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_action_search', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_checkin', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_coupon', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_create', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_rebate', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_relation', [
    ...
    {
        // 创建更新数据表
        PhinxExtend::upgrade($this->table('plugin_wemall_user_transfer', [
